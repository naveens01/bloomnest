...
const CategoriesPage: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-eco-pattern pt-24 sm:pt-28">
      {/* Enhanced Hero Section */}
      <section className="relative bg-eco-gradient py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
